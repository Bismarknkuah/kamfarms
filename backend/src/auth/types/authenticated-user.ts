...
export interface AuthenticatedUser {
  ...
  status: string;
  roles: ResolvedRole[];
  /** True when this account was created with (or reset to) a
   * temporary password and hasn't chosen their own yet - checked on
   * the frontend to force a redirect to /change-password before
