      ...
      where: search
        ? {
            OR: [
              ...
              // Phone is often the more reliable match when a sales
              // officer is checking whether a customer they're about
              // to type in already exists - two customers can share a
              // similar name, but rarely the same phone number.
