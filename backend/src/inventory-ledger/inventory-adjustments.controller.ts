...
export class InventoryAdjustmentsController {
  ...
  approve(@Param('id') id: string, @Body() dto: ApproveInventoryAdjustmentDto, @CurrentUser() actor: AuthenticatedUser) {
    return this.inventoryAdjustmentsService.approve(id, dto, actor);
  }
