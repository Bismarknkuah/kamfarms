...
export class RolesController {
  ...
  @Patch(':code')
  @RequirePermission(PERMISSIONS.ROLES_MANAGE)
  updateDetails(@Param('code') code: string, @Body() dto: UpdateRoleDetailsDto, @CurrentUser() actor: AuthenticatedUser) {
    return this.rolesService.updateDetails(code, dto, actor);
  }
