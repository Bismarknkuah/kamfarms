...
export class WarehousesController {
  ...
  // Declared before ':id' deliberately - a literal path segment needs
  // to be registered ahead of a wildcard param or the wildcard would
  // capture it first. A name-only list, not gated by warehouse.view:
  // a Farm Manager needs to pick a destination warehouse for a dispatch
