  ...
  return (
    <main className="bg-rice-50">
      ...
      <section className="relative flex min-h-[92vh] items-end overflow-hidden bg-paddy-900">
        <Image src="/pectra-rice.jpg" alt="Pectra Rice - Superfine Perfumed Rice" fill priority className="animate-slow-zoom object-cover object-center opacity-90" />
      ...
      <section className="border-b border-paddy-100 bg-rice-50">
        <Reveal className="mx-auto grid max-w-6xl grid-cols-3 divide-x divide-paddy-100 px-6">
      ...
      <section id="chain" className="bg-paddy-900 py-24">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="mt-14 grid gap-px overflow-hidden rounded-3xl bg-paddy-700/40 sm:grid-cols-2 lg:grid-cols-3">
            {CHAIN.map((item, i) => (
              <Reveal key={item.step} delay={i * 60} className="bg-paddy-900 p-8 transition hover:bg-paddy-700/60">
      ...
      <section id="roles" className="mx-auto max-w-6xl px-6 py-24">
        ...
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {ROLES.map((role, i) => (
            <Reveal key={role.name} delay={i * 40} className="rounded-2xl border border-paddy-100 bg-white p-7 transition duration-300 hover:-translate-y-1 hover:border-husk-300 hover:shadow-xl">
      ...
      <section id="principles" className="bg-soil-100">
        <div className="mx-auto grid max-w-6xl md:grid-cols-2">
          ...
          <Reveal className="flex flex-col justify-center px-6 py-16 md:px-14">
      ...
      <section className="relative overflow-hidden bg-paddy-900 py-28">
        <Image src="/pectra-rice.jpg" alt="" fill aria-hidden className="animate-slow-zoom object-cover opacity-20" />
